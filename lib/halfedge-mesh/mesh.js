...
module.exports = (function(){
    ...
    var iterateObj = function(obj, callback) {
        for (var prop in obj) {
    ...
    var parseGeometry = function(geo){
        ...
        var boundaryEdges = {};
        iterateObj(that.frontier, function(edgeID, edge) {
        ...
        iterateObj(boundaryEdges, function(edgeID, initial) {
            var active = initial;
    ...
    var isManifold = function() {
        ...
        if (getProperty(this.frontier)) { // non-empty frontier means open edges
            return false;
        }
    };

    var getFrontierEdge = function() {
        var edgeID = getProperty(this.frontier);
    ...
    var iterateFrontier = function(callback) {
        ...
        while (!emptyObj(that.frontier)) {
            if (counter++ >= cutoff) {
                console.log("Hit halfedge traversal iteration depth limit.");
                break;
            }
